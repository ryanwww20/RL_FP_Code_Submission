...
# See comment in `spins/goos_sim/maxwell/simulate.py`: multiprocessing pools
# created at import time break on Windows spawn. Use a single-process direct
# solver there (or when explicitly requested).
